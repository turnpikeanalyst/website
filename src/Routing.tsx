  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="/digital-content-services"
          element={<DigitalContentServices />}
        />
        ...
        <Route
          ...
          element={<IndustriesAndProcess />}
        />
        <Route path="//industries/insurance" element={<Insurance />} />
        <Route
          path="//industries/life-sciences"
          element={<LifeScienceAndPharma />}
        />
        <Route
          path="//industries/consumer-electronics"
          element={<ConsumerElectronics />}
        />
        <Route
          path="//industries/engineering-construction"
          element={<EngineeringConstruction />}
        />
        <Route
          path="//industries/engineering-construction"
          element={<EngineeringConstruction />}
        ...
        <Route
          path="//industries/natural-resources"
        ...
        <Route
          ...
          element={<TransportationAndServices />}
        />
        ...
        <Route
          ...
          element={<ServicePage {...pageData.applications} />}
        />
        <Route path="/services/ai" element={<ServicePage {...pageData.ai} />} />
        <Route
          path="/services/business-process"
          element={<ServicePage {...pageData.businessProcess} />}
        />
        <Route
          path="/services/business-solutions"
          element={<ServicePage {...pageData.businessSolutions} />}
        />
        <Route
          path="/services/cloud"
          element={<ServicePage {...pageData.cloud} />}
        />
        <Route
          path="/services/consulting"
          element={<ServicePage {...pageData.consulting} />}
        />
        <Route
          path="/services/cybersecurity"
          element={<ServicePage {...pageData.cybersecurity} />}
        />
        <Route
          path="/services/data-analytics"
          element={<ServicePage {...pageData.dataAnalytics} />}
        />
        <Route
          path="/services/design-experience"
          element={<ServicePage {...pageData.designExperience} />}
        />
        <Route
          path="/services/digital-marketing"
          element={<ServicePage {...pageData.digitalMarketing} />}
        />
        <Route
          path="/services/engineering"
          element={<ServicePage {...pageData.engineering} />}
        />
        <Route
          path="/services/infrastructure"
          element={<ServicePage {...pageData.infrastructure} />}
        />
        <Route
          path="/services/sustainability"
          element={<ServicePage {...pageData.sustainability} />}
        />
        <Route
          path="/services/talent-cloud"
          element={<ServicePage {...pageData.talentCloud} />}
        />
      </Routes>
    </div>
  );
