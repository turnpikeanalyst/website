...
function EngineeringConstruction() {
  return (
    <div>
      ...
      <div className="Construction flex flex-col justify-center ">
        <h4 className="text-white font-semibold text-4xl ml-5 mb-4">Engineering Construction & Operations

        </h4>
        <p className="text-white text-lg ml-5">
       
        TurnPikeAnalyst is specialized in your Engineering and Construction end to end IT 
